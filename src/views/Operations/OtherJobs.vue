        ...
        <div class="p-6 space-y-6">
          ...
          <div class="space-y-2">
            ...
            <textarea
              ...
              rows="6"
              class="w-full rounded-lg border bg-white px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-1 dark:bg-gray-800 dark:text-white"
              :class="submittedOnce && isDescriptionInvalid ? 'border-red-500 focus:ring-red-500/20 dark:border-red-600' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500/20 dark:border-gray-700'"
