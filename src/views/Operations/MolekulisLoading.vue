      ...
      <form class="space-y-6" @keydown.enter.prevent>
            ...
            <div class="flex items-center justify-start">
              <div class="w-full md:w-auto">
                ...
                <flat-pickr
                  v-model="formWhen"
                  :config="dateConfig"
                  class="h-11 w-full md:w-60 appearance-none rounded-lg border bg-white px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-1 dark:bg-gray-800 dark:text-white"
                  :class="submittedOnce && isWhenInvalid ? 'border-red-500 focus:ring-red-500/20 dark:border-red-600' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500/20 dark:border-gray-700'"
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                <div>
                  ...
                  <flat-pickr v-model="newLoad.time" :config="timeConfig" class="h-11 w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white" placeholder="Select time" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Product</label>
                  <select v-model="newLoad.product" class="h-11 w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                    <option disabled value="">Select product</option>
                    <option value="Hyvolt I">Hyvolt I</option>
                    <option value="Hyvol III">Hyvol III</option>
                  </select>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
              <div>
                ...
                <select v-model="whoSampler" class="h-11 w-full appearance-none rounded-lg border bg-white px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-1 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                  :class="submittedOnce && isWhoInvalid ? 'border-red-500 focus:ring-red-500/20 dark:border-red-600' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500/20'"
                >
                  <option disabled value="">Select sampler</option>
              ...
              <div>
                ...
                <flat-pickr v-model="whoStart" :config="timeConfig" class="h-11 w-full appearance-none rounded-lg border bg-white px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-1 dark:border-gray-700 dark:bg-gray-800 dark:text-white" :class="submittedOnce && isStartInvalid ? 'border-red-500 focus:ring-red-500/20 dark:border-red-600' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500/20'" placeholder="Select time" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-900 dark:text-white mb-2">End</label>
                <flat-pickr v-model="whoEnd" :config="timeConfig" class="h-11 w-full appearance-none rounded-lg border bg-white px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-1 dark:border-gray-700 dark:bg-gray-800 dark:text-white" :class="submittedOnce && isEndInvalid ? 'border-red-500 focus:ring-red-500/20 dark:border-red-600' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500/20'" placeholder="Select time" />
              </div>
              <div>
      ...
      <ComponentCard title="Loads" description="Recent records">
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <select class="rounded-md border border-gray-300 bg-white px-2 py-1 text-sm text-gray-900 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white" v-model.number="rowsPerPage" @change="onRowsPerPageChange">
...
const loadItems = async () => {
  try {
    const res = await listMolekulisLoadings({ page: currentPage.value, limit: rowsPerPage.value, sortBy: 'when', sortOrder: 'desc' })
